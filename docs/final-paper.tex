...
\todo{0memory, no gossip model: show how defectors dominate}

\subsection{Remember defectors}
\todo{baseline + memory, no gossip: promoted cooperation, defectors catch up}

\subsection{Gossip about defectors}
\todo{gossip model: defectors die off quickly}
\todo{check robustness across harshness}
