...
This is the end of the introduction of the paper; composed of a short background, motivation, and explanation of the goals of this paper.
...
We will use $S = -1.5$ from now on, unless otherwise noted.
...
\begin{figure}[!h]
  ...
  \makebox[\textwidth]{
    \includegraphics[width=\textwidth/3]{spatial-memory0+gossip0+range0.pdf}
    \includegraphics[width=\textwidth/3]{spatial-memory0+gossip0+range0-B.pdf}
  ...
  \makebox[\textwidth]{
    \includegraphics[width=\textwidth/3]{spatial-memory5+gossip0+range0-A.pdf}
  ...
  \makebox[\textwidth]{
    \includegraphics[width=\textwidth/3]{spatial-memory1+gossip1+range3-A.pdf}
    \includegraphics[width=\textwidth/3]{spatial-memory1+gossip1+range3-B.pdf}
...
\todo{memory effect : both live well, cooperators have an edge and are faster to saturate}

\todo{gossip effect : cooperation flourishes, compare to the human experiment}

\todo{gossip model is robust against environmental harshness}
...
We aim to provide a solid foundation for others to reproduce, reuse, and build upon this paper.
